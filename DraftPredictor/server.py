...
class StrategyManager:
    def __init__(self):
        ...
        # User has access to Gemini 3 Flash Preview as confirmed by debug script
    ...
    def generate_strategy(self, blue_team, red_team):
        ...
        print(f"🧠 Generating Strategy for {blue_team.get('name')} vs {red_team.get('name')}...")
        ...
        try:
            ...
            print("\n✅ Strategy Generated from Gemini:")
